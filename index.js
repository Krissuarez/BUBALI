	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '593991702833@s.whatsapp.net'
...
/******JUEGOS SHANDUY LA PUTA MADRE NO TE OLVIDES******/					
  ...
  client.updatePresence(from, Presence.composing) 
	...
	case 'creador':
	       client.sendMessage(from, {displayname: "BUBIN 🥸", vcard: vcard}, MessageType.contact, { quoted: mek})
		client.sendMessage(from, 'Hola 👋 te saluda KRIS, este es un mensaje predeterminado al igual que el audio.\n\nArriba esta mi contacto por si tienen algun problema con las descargas o yo que se.\nYo no soy dueño de este bot ni tampoco lo controlo, yo solo cree la base de datos y le doy mantenimiento_',MessageType.text, { quoted: mek} )
